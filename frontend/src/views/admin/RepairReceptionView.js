...
const RepairReception = () => {
    ...
    const getAllRepairStatus = async () => {
        ...
        const response = await axios.get('http://43.203.11.194:8081/api/repair/getRepairStatus',
        {
            headers: {
    ...
    const registerRepair = async (reId) => {
        ...
        await axios.post('http://43.203.11.194:8081/api/repair/processrepair',
        {
            repairIdx: reId,
    ...
    return (
        <>
            ...
            <AdminSideBar content={window.localStorage.getItem("name")} selectedMenu={{'admin': false, 'user': false, "as" : true, "board" : false, "chat" : false, "faq" : false}}/>
            <section id="main">
